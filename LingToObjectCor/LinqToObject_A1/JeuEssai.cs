...
namespace LinqToObject_A1
{
    public static class JeuEssai
    {
        ...
        public static List<Stagiaire> CreeListeStagiaire() =>
             ...
             new List<Stagiaire>
            {
                ...
                new Stagiaire { Matricule = "14108868", Nom = "Alamic", Prenom = "Pierre" },
                 new Stagiaire { Matricule = "14108868", Nom = "Alamic", Prenom = "Pierre" },
                  new Stagiaire { Matricule = "14108868", Nom = "Alamic", Prenom = "Pierre" },
                   new Stagiaire { Matricule = "14108868", Nom = "Alamic", Prenom = "Pierre" }
            };
    ...
    public class Stagiaire
    {
        ...
        public double? Age { get => (DateNaissance.HasValue) ? (DateTime.Now - DateNaissance.Value).Days / 365.0 : null; }
    }
}
