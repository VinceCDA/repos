...
namespace LinqToEntityCore_1
{
    ...
    {
        static ComptoirAnglaisEntities dbcontexte = null;
        ...
        static void Requete1A(string debNom)
        {
            var req = dbcontexte.
                Customers.
        ...
        /// </summary>
        /// <param name="debNom"></param>
        static void Requete1B(string debNom)
        {
        ...
        static void Requete2A(string debNom)
        {
        ...
        static void Requete2B(string debNom)
        {
        ...
        /// </summary>
        /// <param name="debNom"></param>
        static void Requete3A(string debNom)
        {
            var req = dbcontexte.Customers
                .Where(c => c.CompanyName.StartsWith(debNom))
        ...
        static void Requete3B(string debNom)
        {
            var req = (from c in dbcontexte.Customers
                       where (c.CompanyName.StartsWith(debNom))
                       orderby (c.CompanyName)
                       select new { nom = c.CompanyName }).FirstOrDefault();
            ObjectDumper.Write(req);
            Console.ReadLine();
        }
        #endregion
        ...
        static void Requete4A(string pays)
        {
         ...
         /// </summary>
         /// <param name="pays"></param>
        static void Requete4B(string pays)
        {
        ...
        /// </summary>
        /// <param name="pays"></param>
        static void Requete4C(string pays)
        {
        ...
        /// </summary>
        /// <param name="pays"></param>
        static void Requete4D(string pays)
        {
            ...
            var req = from e in dbcontexte.Employees.Where(emp => emp.Country == pays)
                      ...
                      select new { Prenom = e.FirstName, Nom = e.LastName, NumCde = o.OrderId, DateCde = o.OrderDate };
        ...
        static void Requete7A() // clients sans commande Syntaxe Méthode
        {
        ...
        static void Requete7B() // clients sans commande Syntaxe Requete
        {
            // Filtre sur valeur de l'agrégat
        ...
        static void Requete8A(int anneeDerniereCommande)
        {
        ...
        /// </summary>
        /// <param name="anneeDerniereCommande"></param>
        static void Requete8B(int anneeDerniereCommande)
        {
            var req = from c in dbcontexte.Customers
        ...
        static void Requete10B() // 
        {
            ...
            var CA2 = from C in dbcontexte.Customers.Where(c => c.Country == "France")
                      ...
                      select new { C.CompanyName, C.CustomerId, TotalLigne = (double)OD.UnitPrice * (1.0 - OD.Discount) * OD.Quantity };
        ...
        static void Requete10C() // 
        {
            ...
            var CA2 = from C in dbcontexte.Customers.Where(c => c.Country == "France")
                      ...
                      select new { C.CompanyName, C.CustomerId, TotalLigne = (Y == null) ? 0 : (double)Y.UnitPrice * (1.0 - Y.Discount) * Y.Quantity };
        ...
        static void Requete12B() // Le prix le plus élevé par catégorie
        {
            var produitCherCat =
        ...
        static void Requete12C() // Le prix le plus élevé par catégorie
        {
