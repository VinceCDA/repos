...
namespace Poo3
{
    ...
    public class Salarie
    {
        ...
        {
            get { return Salarie._nombreInstances; }
        }
        /// <summary>
        /// 
        /// </summary>
        ...
        public decimal SalaireBrut
        {
            ...
            set
            {
              //  decimal ancienSalaire = _salaireBrut;
                ...
                if (_salaireBrut != 0 && _salaireBrut != value ) OnModificationSalaire(this, new SalaireModifieEventArgs(_salaireBrut, value));
        ...
        public virtual void OnModificationSalaire(Salarie salarie, SalaireModifieEventArgs salaireModifieEventArgs)
        {
          if( ModificationSalaire != null) { ModificationSalaire(this, salaireModifieEventArgs); }
        }
        ...
        #endregion
        #region event
        public event EventHandler<SalaireModifieEventArgs> ModificationSalaire;
        #endregion
