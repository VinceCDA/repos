...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    &nbsp;<div class="form-group">
        ...
        <div class="input-group">
            ...
            <input type="search" name="simple_select_text" placeholder="type to search..." autocomplete="off" class="form-control basicAutoSelect" data-url="https://localhost:44327/api/AppellationRomes">
...
<%--            <asp:TextBox id="exercicemetier" name="exercicemetier" type="text" class="form-control" runat="server" required="required" ClientIDMode="Static"></asp:TextBox>--%>
    ...
    <div class="form-group">
        ...
        <div class="input-group">
            ...
            <input id="coderome2" name="coderome2" type="text" class="form-control" runat="server">
        </div>
    </div>
    <div class="form-group">
