...
public static class Configuration
{
    ...
    internal static void ConfigurerServices(string[] args)
    {
        ...
        if (TypeDAL == "DALADO")
        {
            ...
            if (TypeSGBD == "MySql")
            {
                DBDAO.DbConnectionString = "server=localhost;database=Bibliotheque;user=root;password=root";
        ...
        if (TypeDAL == "DALEF")
        {
            ...
            if (TypeSGBD == "MySql")
            {
                DBEF.DbConnectionString = "server=localhost;database=Bibliotheque;user=root;password=root";
