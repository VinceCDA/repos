...
namespace LingToEntities.Models
{
    public partial class ComptoirAnglaisEntities : DbContext
    {
        ...
        public virtual DbSet<CaAnne2009> CaAnne2009s { get; set; }
        ...
        public virtual DbSet<ShippersRate> ShippersRates { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
                optionsBuilder.UseSqlServer("Server=localhost;Database=ComptoirAnglais_V1;Trusted_Connection=True;").UseLoggerFactory(Consignation);
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<CaAnne2009>(entity =>
            {
                entity.HasNoKey();

                entity.ToView("CA_Anne_2009");
            ...
            modelBuilder.Entity<ShippersRate>(entity =>
            {
                entity.HasNoKey();

                entity.ToView("ShippersRate");
