...
namespace GerenateurProcStoc
{
    public static class GenerateurProcStoc
    {
        ...
        public static HashSet<StoredProc> StoredProcs { get => _storedProcs; }
        public static string CmdDerive { get => _cmdDerive; set => _cmdDerive = value; }
        #endregion
        /// <summary>
            ...
            using (SqlConnection dbCon = new SqlConnection(_connectionString))
            {
                ...
                using (SqlCommand cmd = new SqlCommand())
                {
                    ...
                    foreach (Parametre parametre in parametres)
                    {
                        ...
                        {
                            listeParametres.Append($"parameter.Direction = ParameterDirection.InputOutput;\r\n");
                        }
